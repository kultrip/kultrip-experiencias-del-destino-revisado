      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link to="/" className="text-gray-700 hover:text-orange-500 font-medium">Inicio</Link>
            <Link to="/" className="text-gray-700 hover:text-orange-500 font-medium">Experiencias</Link>
            <button 
              onClick={() => {
                navigate('/');
                // This will trigger the filter in the home page - we'll need to add filter state management
                window.dispatchEvent(new CustomEvent('filterChange', { detail: 'galicia' }));
              }}
            ...
            <button 
              onClick={() => {
                navigate('/');
                window.dispatchEvent(new CustomEvent('filterChange', { detail: 'andalucia' }));
              }}
              className="text-gray-700 hover:text-orange-500 font-medium"
            >
              Andalucía
            ...
            <button 
              onClick={() => {
                navigate('/');
                window.dispatchEvent(new CustomEvent('filterChange', { detail: 'baleares' }));
              }}
              className="text-gray-700 hover:text-orange-500 font-medium"
            >
              Baleares
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                    ...
                    <nav className="py-2">
                      ...
                      <button
                        onClick={() => {
                          setShowUserMenu(false);
                          // For now, this will just close the menu. We can implement wishlist later
                          alert('Lista de Deseos - Funcionalidad próximamente disponible');
                        }}
