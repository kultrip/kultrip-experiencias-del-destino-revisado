-- Booking and Sales System Schema for Kultrip
-- Run this SQL to create the complete booking/sales functionality
...
-- Customer preferences and history (extend user_profiles)
...
CREATE INDEX idx_bookings_date ON public.bookings(experience_date);
