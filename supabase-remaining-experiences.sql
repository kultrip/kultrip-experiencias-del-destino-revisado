...
(
  ...
  0,
  'Gastronomía',
  'Grupos pequeños, ideal parejas',
  ARRAY['2 noches en Hotel Spa Norat O Grove 3* Superior', 'Desayuno buffet diario', 'Acceso al circuito termal cada día', 'Menú degustación en restaurante Michelin (Culler de Pau o Pepe Vieira)', 'Seguro de viaje y asistencia', 'Asesoría personalizada para experiencias gastronómicas'],
  '[
...
(
  ...
  'Una excursión completa por los tesoros naturales y culturales de la costa lucense: monumentos, historia, gastronomía y arquitectura indiana en un solo día.',
  'Adéntrate en la Mariña Lucense con una ruta pensada para explorar sus maravillas naturales y culturales. El día comienza con la visita a la Playa de las Catedrales, Monumento Natural famoso por sus imponentes arcos y formaciones rocosas, accesible solo con marea baja. Continuamos hacia Mondoñedo, localidad histórica con su catedral del siglo XIII, calles empedradas y leyendas de escritores y emigrantes ilustres. El almuerzo en Ribadeo te permitirá degustar los sabores locales antes de pasear por el centro histórico y admirar la arquitectura indiana, con la Torre de los Moreno como joya modernista. Todo el viaje es guiado por expertos y el transporte está incluido desde Lugo o Santiago. Perfecto para grupos y familias, con opción de alternativas si no se alcanza el mínimo de participantes.',
  '10 horas (salida 10:00, regreso 20:00)',
  '€95 por persona',
  'Mariña Lucense (Mondoñedo, Playa de las Catedrales, Ribadeo)',
  'Requiere mín. 4 participantes',
  'daytrips',
  'https://images.pexels.com/photos/13683723/pexels-photo-13683723.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  0.0,
  0,
  'Excursiones',
  'Grupos de 4+, ideal familias',
  ARRAY['Transporte desde Lugo/Santiago', 'Visitas guiadas por expertos locales', 'Entrada y visita a la Playa de las Catedrales', 'Visita a la Catedral y casco histórico de Mondoñedo', 'Almuerzo típico en Ribadeo', 'Recorrido por arquitectura indiana y Torre de los Moreno', 'Narración histórica y cultural', 'Alternativas garantizadas si no se alcanza el mínimo de participantes'],
  '[
...
(
  'Ruta del Camino de Santiago (adaptada)',
  'Una introducción guiada al Camino de Santiago, con recorrido a pie, historia, cultura y visita a la Catedral de Santiago en grupo reducido.',
  'Descubre la esencia del Camino de Santiago en una experiencia adaptada para grupos pequeños y personas que deseen vivir la tradición jacobea de manera cómoda y guiada. El tour abarca 5 km de recorrido a pie por los últimos tramos del Camino, acompañado de explicaciones sobre la historia, las leyendas y el significado del peregrinaje. La visita a la Catedral de Santiago es el broche final, con posibilidad de ampliar la experiencia añadiendo la entrada al Pórtico de la Gloria (opcional y sujeto a disponibilidad). Nuestro guía especializado te ayudará a comprender el valor cultural y espiritual del Camino, y te dará indicaciones para aprovechar al máximo tu visita a la ciudad. Ideal para quienes buscan una experiencia auténtica y personalizada.',
  'Medio día (09:00 a 13:00)',
  '€75 por persona (mín. 2 personas)',
  'Santiago de Compostela, A Coruña',
  'Mín. 2 personas',
  'daytrips',
  'https://images.pexels.com/photos/11690243/pexels-photo-11690243.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  0.0,
  0,
  'Camino de Santiago',
  'Grupos mínimos de 2, ideal familias o amigos',
  ARRAY['Recorrido guiado de 5 km por el Camino de Santiago', 'Historia y contexto cultural del peregrinaje', 'Visita a la Catedral de Santiago (Pórtico de la Gloria opcional)', 'Guía especializado en la ruta y la ciudad', 'Recomendaciones para explorar Santiago de Compostela'],
  '[
...
(
  'Cata de Productos Autóctonos de Galicia',
  'Descubre los sabores auténticos de Galicia con una cata guiada de quesos, vinos y productos del mar, visitando productores locales y aprendiendo los secretos de la gastronomía gallega.',
  'Sumérgete en una experiencia gastronómica única que te llevará a descubrir los sabores más auténticos de Galicia. En esta cata de productos autóctonos, tendrás la oportunidad de degustar una cuidada selección de quesos artesanales elaborados por maestros queseros locales, vinos con denominación de origen de las mejores bodegas gallegas y productos del mar frescos que reflejan la rica tradición marinera de la región.\n\nNuestro guía experto te acompañará durante todo el recorrido, compartiendo historias fascinantes sobre la tradición culinaria gallega, los métodos de elaboración ancestrales y los secretos mejor guardados de cada producto. La experiencia incluye visitas a productores locales, donde podrás conocer de primera mano los procesos de elaboración y hablar directamente con los artesanos.\n\nAdemás de la degustación, aprenderás sobre el maridaje perfecto entre vinos y quesos, las características únicas del terroir gallego, y cómo identificar productos de calidad. La experiencia culmina con una degustación especial de productos del mar, incluyendo percebes, mejillones de las rías gallegas y pulpo á feira preparado según la receta tradicional.',
  '3 horas (10:00 a 13:00)',
  '€55 por persona',
  'Galicia (consultar ubicación exacta)',
  null,
  'gastronomy',
  'https://images.pexels.com/photos/1267697/pexels-photo-1267697.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  0.0,
  0,
  'Gastronomía',
  'Grupos abiertos',
  ARRAY['Degustación de 8 quesos artesanales diferentes', 'Cata de 4 vinos con D.O. Rías Baixas y Ribeiro', 'Productos del mar frescos (percebes, mejillones, pulpo á feira)', 'Guía gastronómico especializado', 'Visita a quesería tradicional', 'Material de cata profesional', 'Certificado de participación'],
  '[
...
(
  'Ruta de Cata de Vino en Ribeira Sacra',
  'Explora el mágico mundo del vino gallego: navegación en catamarán, visitas a bodegas, catas guiadas y gastronomía local en los paisajes únicos de la Ribeira Sacra.',
  'Adéntrate en el universo vinícola de la Ribeira Sacra con una ruta completa que combina naturaleza, cultura y enología. La experiencia comienza con la salida de Santiago y la llegada al embarcadero de Doade, donde embarcarás en un catamarán para navegar por el río Miño y admirar los viñedos en terrazas y los cañones fluviales. La primera parada será la Adega Vella, donde degustarás 4 vinos y conocerás los secretos de la viticultura heroica gallega. Tras el almuerzo típico en restaurante de la zona, visitarás el castillo de Castro Caldelas, testigo de la historia medieval gallega. La jornada culmina en la bodega Ponte da Boga, con una cata de 3 vinos y explicación sobre el terroir único de la Ribeira Sacra. Una experiencia diseñada para amantes del vino y la naturaleza, con guía especializado y opción de personalización según intereses del grupo.',
  'Día completo (09:00 – 18:30)',
  'Consultar precio',
  'Ribeira Sacra, Lugo',
  'Requiere mín. 4 participantes',
  'gastronomy',
  'https://images.pexels.com/photos/1407846/pexels-photo-1407846.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  0.0,
  0,
  'Enoturismo',
  'Grupos mínimos de 4, ideal enoturistas',
  ARRAY['Paseo en catamarán por el río Miño y visita a viñedos', 'Visita y cata en Adega Vella (4 vinos)', 'Almuerzo típico gallego', 'Visita guiada al castillo de Castro Caldelas', 'Visita y cata en Ponte da Boga (3 vinos)', 'Guía especializado en enoturismo', 'Narración sobre historia y cultura vitivinícola', 'Alternativas garantizadas si no se alcanza el mínimo de participantes'],
  '[
...
(
  'Costa da Morte Mística',
  'Recorre la legendaria Costa da Morte visitando sus faros más emblemáticos y descubriendo las leyendas que envuelven este litoral mágico.',
  'Descubre los misterios y leyendas de la Costa da Morte en una jornada completa que te llevará por algunos de los paisajes más dramáticos y espirituales de Galicia. Esta ruta te permitirá visitar tres faros emblemáticos, cada uno con su propia historia y personalidad única.\n\nComenzarás en Cabo Vilán, el primer faro eléctrico de España, continuarás hacia Muxía con su santuario y las piedras sagradas, y terminarás en Finisterre, el mítico "fin del mundo" donde los romanos creían que terminaba la tierra conocida.\n\nDurante el recorrido, tu guía especializado compartirá las leyendas marineras, historias de naufragios, tradiciones celtas y la rica mitología que envuelve esta costa. La experiencia culmina con la puesta de sol en Finisterre, un momento mágico que conecta con siglos de tradición y espiritualidad.',
  '8 horas',
  '€90 por persona (mín. 2 personas)',
  'Costa da Morte, A Coruña',
  null,
  'sunset',
  'https://images.pexels.com/photos/10713938/pexels-photo-10713938.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  4.8,
  145,
  'Atardeceres',
  'Grupos pequeños (mín. 2)',
  ARRAY['Visita a 3 faros históricos', 'Guía especializado en leyendas', 'Transporte cómodo', 'Entrada a museos de faros', 'Tiempo para el atardecer en Finisterre', 'Merienda tradicional', 'Seguro de viaje'],
  '[
